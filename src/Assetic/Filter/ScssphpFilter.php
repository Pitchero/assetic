...
class ScssphpFilter implements DependencyExtractorInterface
{
    ...
    {
        $legacyFormatters = [
            'scss_formatter' => \Leafo\ScssPhp\Formatter\Expanded::class,
            'scss_formatter_nested' => \Leafo\ScssPhp\Formatter\Nested::class,
            'scss_formatter_compressed' => \Leafo\ScssPhp\Formatter\Compressed::class,
            'scss_formatter_crunched' => \Leafo\ScssPhp\Formatter\Crunched::class,
        ];
